            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><g:link action="index"><i class="fa fa-circle-o"></i> Main Info</g:link></li>
                        <li class=""active><g:link action="traceability"><i class="fa fa-circle-o"></i> Traceability <span class="label label-primary pull-right">${traceMap.trace.size()}</span></g:link></li>
                    </ul>
                </li>
            </ul>
        </section>
